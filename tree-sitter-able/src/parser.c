...
enum ts_symbol_identifiers {
  ...
  aux_sym_interpolated_string_part_repeat1 = 27,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [sym_interpolation] = "interpolation_expression",
  [aux_sym_source_file_repeat1] = "source_file_repeat1",
  [aux_sym_string_literal_repeat1] = "string_literal_repeat1",
  [aux_sym_interpolated_string_literal_repeat1] = "interpolated_string_literal_repeat1",
  [aux_sym_interpolated_string_part_repeat1] = "interpolated_string_part_repeat1",
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym_interpolated_string_part_repeat1] = aux_sym_interpolated_string_part_repeat1,
};
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [aux_sym_interpolated_string_part_repeat1] = {
    .visible = false,
    .named = false,
  },
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_char_literal, 3, 0, 0),
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_char_literal, 3, 0, 0),
  ...
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolated_string_literal, 2, 0, 0),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpolated_string_literal, 2, 0, 0),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_interpolated_string_literal_repeat1, 2, 0, 0),
  [75] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_interpolated_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  [78] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_interpolated_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(4),
  [81] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_interpolated_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  ...
  [96] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_interpolated_string_part_repeat1, 2, 0, 0),
  [98] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_interpolated_string_part_repeat1, 2, 0, 0), SHIFT_REPEAT(14),
  [101] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_interpolated_string_part_repeat1, 2, 0, 0), SHIFT_REPEAT(14),
  [104] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_interpolated_string_literal_repeat1, 1, 0, 0),
  [106] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_interpolated_string_literal_repeat1, 1, 0, 0), SHIFT(14),
  [109] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_interpolated_string_literal_repeat1, 1, 0, 0), SHIFT(14),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 0),
  [114] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(16),
  [117] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(16),
  ...
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpolation, 3, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 3, 0, 0),
