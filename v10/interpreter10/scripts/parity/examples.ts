...
export const DEFAULT_EXAMPLES_ROOT = path.resolve(REPO_ROOT, "interpreter10/testdata/examples");
const DEFAULT_PARITY_DEPS_ROOT = path.resolve(REPO_ROOT, "interpreter10/testdata/examples/deps/vendor");
