...
- Declaration bindings are installed before analysing the right-hand side so recursive async/proc scenarios do not trip undefined errors (`interpreter-go/pkg/typechecker/literals.go:203`).
