...
func (c *Checker) initBuiltinInterfaces() {
	...
	for _, entry := range []struct {
		...
		{"Ord", PrimitiveType{Kind: PrimitiveBool}},
		{"Ord", PrimitiveType{Kind: PrimitiveChar}},
		{"Ord", PrimitiveType{Kind: PrimitiveString}},
		{"Ord", IntegerType{Suffix: "i8"}},
		{"Ord", IntegerType{Suffix: "i16"}},
		{"Ord", IntegerType{Suffix: "i32"}},
		{"Ord", IntegerType{Suffix: "i64"}},
		{"Ord", IntegerType{Suffix: "i128"}},
		{"Ord", IntegerType{Suffix: "u8"}},
		{"Ord", IntegerType{Suffix: "u16"}},
