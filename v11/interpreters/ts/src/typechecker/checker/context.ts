...
export type CheckerContextHost = {
  ...
  getFunctionInfo: (key: string) => any;
  setFunctionInfo: (key: string, info: any) => void;
...
export function createCheckerContext(host: CheckerContextHost): StatementContext {
  ...
  ctx.getFunctionInfo = host.getFunctionInfo;
  ctx.setFunctionInfo = host.setFunctionInfo;
