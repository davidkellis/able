...
Current state: foundational modules are restored (core/errors, core/interfaces, core/options, core/iteration, core/numeric, collections/array + enumerable + range, text/string). The previous full implementation now lives under `v11/stdlib/quarantine/`.
