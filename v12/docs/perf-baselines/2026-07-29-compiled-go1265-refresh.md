...
- Source measurements through: `2026-07-29T06:13:35.851464Z`
...
| --- | --- | --- | ---: | --- | --- | --- | --- | --- |
| `channel_rollup` | `compiled` | `verified` | 0.0320 | 0.0052 / 6.15x | n/a | n/a | `miss` | — |
| `future_pipeline` | `compiled` | `verified` | 0.0300 | 0.0052 / 5.77x | n/a | n/a | `miss` | — |
| `future_await_race` | `compiled` | `verified` | 0.0420 | 0.0038 / 11.05x | n/a | n/a | `miss` | — |
| `await_channel_mux` | `compiled` | `verified` | 0.1500 | 0.0048 / 31.25x | n/a | n/a | `miss` | — |
| `mutex_ledger` | `compiled` | `verified` | 0.0800 | 0.0043 / 18.60x | n/a | n/a | `miss` | — |
| `mutex_await_journal` | `compiled` | `verified` | 0.1980 | 0.0038 / 52.11x | n/a | n/a | `miss` | — |
| `mutex_work_queue` | `compiled` | `verified` | 0.4860 | 0.0051 / 95.29x | n/a | n/a | `miss` | — |
...
| `concurrent_text_index` | `compiled` | `verified` | 0.0400 | 0.0068 / 5.88x | n/a | n/a | `miss` | — |
| `validated_job_pipeline` | `compiled` | `verified` | 0.0560 | 0.0048 / 11.67x | n/a | n/a | `miss` | — |
| `dependency_wave_validation` | `compiled` | `verified` | 0.0340 | 0.0043 / 7.91x | n/a | n/a | `miss` | — |
| `concurrent_event_routing` | `compiled` | `verified` | 0.0320 | 0.0057 / 5.61x | n/a | n/a | `miss` | — |
| `concurrent_document_pipeline` | `compiled` | `verified` | 0.0240 | 0.0073 / 3.29x | n/a | n/a | `miss` | — |
...
| `concurrent_signal_dispatch` | `compiled` | `verified` | 0.0300 | 0.0050 / 6.00x | n/a | n/a | `miss` | — |
| `concurrent_transform_chain` | `compiled` | `verified` | 0.0320 | 0.0048 / 6.67x | n/a | n/a | `miss` | — |
| `concurrent_policy_callbacks` | `compiled` | `verified` | 0.0300 | 0.0042 / 7.14x | n/a | n/a | `miss` | — |
| `concurrent_graph_visitors` | `compiled` | `verified` | 0.0240 | 0.0040 / 6.00x | n/a | n/a | `miss` | — |
| `concurrent_audio_voices` | `compiled` | `verified` | 0.0300 | 0.0039 / 7.69x | n/a | n/a | `miss` | — |
| `concurrent_packet_codecs` | `compiled` | `verified` | 0.0300 | 0.0039 / 7.69x | n/a | n/a | `miss` | — |
| `concurrent_scene_tiles` | `compiled` | `verified` | 0.0760 | 0.0037 / 20.54x | n/a | n/a | `miss` | — |
| `concurrent_tree_folds` | `compiled` | `verified` | 0.0560 | 0.0052 / 10.77x | n/a | n/a | `miss` | — |
| `concurrent_state_machines` | `compiled` | `verified` | 0.0280 | 0.0039 / 7.18x | n/a | n/a | `miss` | — |
| `concurrent_stateful_pipeline` | `compiled` | `verified` | 0.0400 | 0.0058 / 6.90x | n/a | n/a | `miss` | — |
| `fib` | `compiled` | `verified` | 3.1180 | 2.8996 / 1.08x | n/a | n/a | `miss` | — |
| `binarytrees` | `compiled` | `verified` | 8.9780 | 9.2644 / 0.97x | n/a | n/a | `meets` | — |
...
- `v12/docs/perf-baselines/2026-07-29-compiled-go1265-async-compiled-01-selected.json` — `custom` (`2026-07-29T05:52:42.335174Z`)
- `v12/docs/perf-baselines/2026-07-29-compiled-go1265-async-compiled-02-selected.json` — `custom` (`2026-07-29T05:53:13.662617Z`)
...
- `v12/docs/perf-baselines/2026-07-29-compiled-go1265-coverage-extra-compiled-06-selected.json` — `custom` (`2026-07-29T06:13:35.851464Z`)
- `v12/docs/perf-baselines/2026-07-29-compiled-go1265-generality-compiled-01-selected.json` — `custom` (`2026-07-29T05:44:31.578614Z`)
