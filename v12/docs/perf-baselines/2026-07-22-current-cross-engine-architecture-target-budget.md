...
| --- | ---: | ---: | ---: | ---: | ---: |
| compiled | 51 | 5 | 46 | 23.827263 | 14.68% |
| bytecode | 44 | 3 | 41 | 138.485474 | 85.32% |

The full 95-row frontier has 87 misses and 162.312737 seconds above its aggregate target. Bytecode owns 85.32% of that gap.
...
| --- | ---: | ---: | --- |
| `bytecode-text-map` | 8 | 64.822211 | `closed-rejected-candidate` |
...
| `compiled-concurrency` | 13 | 12.248947 | `closed-rejected-candidate` |
| `bytecode-concurrency` | 12 | 8.600842 | `closed-no-shared-leaf` |
| `bytecode-byte-output` | 3 | 5.553789 | `closed-no-shared-leaf` |
| `compiled-text-map` | 7 | 4.009474 | `closed-no-shared-leaf` |
