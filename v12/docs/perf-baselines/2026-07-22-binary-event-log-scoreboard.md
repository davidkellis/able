...
- Source measurements through: `2026-07-22T05:59:20.973255Z`
...
- Compiled: `5/49` selected rankable rows meet the 95%-of-Go target.
- Bytecode: `3/42` selected rankable rows meet both 95%-of-Python and 95%-of-Ruby targets.
- Canonical Able source fingerprints: `98` row fingerprints in JSON; `98` came from the measured source report and the remainder are current-source legacy fingerprints.
- Verifier/declared-input contracts: `98` row fingerprints in JSON; `98` were captured before the timed launch and the remainder are current-contract legacy reconstructions.
...
- Strict candidate selection: `91` reviewed benchmark/mode rows, SHA-256 `9418f5e877a8b93a423ffc4e05ab750f2723a9bc83de91df8d5e014e93139769`; timeout rows remain in full status.
- Matched reference source fingerprints: `142` comparison fingerprints in JSON; `142` came from measured reference reports and the remainder are current-source legacy fingerprints.
...
| `binary_event_log` | `compiled` | `verified` | 0.6880 | 0.0096 / 71.67x | n/a | n/a | `miss` | — |
| `binary_event_log` | `bytecode` | `verified` | 6.8960 | n/a | 0.2385 / 28.91x | 0.3194 / 21.59x | `miss` | — |
...
- `v12/docs/perf-baselines/2026-07-21-validated-job-file-entry-promotion-compiled.json` — `custom` (`2026-07-22T04:50:09.298732Z`)
- `v12/docs/perf-baselines/2026-07-21-validated-job-file-entry-promotion-bytecode.json` — `custom` (`2026-07-22T04:50:09.298732Z`)
- `v12/docs/perf-baselines/2026-07-22-binary-event-log-promotion-compiled.json` — `custom` (`2026-07-22T05:59:20.973255Z`)
- `v12/docs/perf-baselines/2026-07-22-binary-event-log-promotion-bytecode.json` — `custom` (`2026-07-22T05:59:20.973255Z`)
