...
- Source measurements through: `2026-07-20T06:04:06.811332Z`
...
| `regex_suffix_audit` | `compiled` | `verified` | 0.1400 | 0.0054 / 25.93x | n/a | n/a | `miss` | — |
| `regex_suffix_audit` | `bytecode` | `verified` | 3.8520 | n/a | 0.0191 / 201.68x | 0.0435 / 88.55x | `miss` | — |
...
- `v12/docs/perf-baselines/2026-07-20-regex-rebalance-historical-compiled-01.json` — `custom` (`2026-07-19T07:32:59.791896Z`)
- `v12/docs/perf-baselines/2026-07-20-regex-rebalance-historical-compiled-02.json` — `custom` (`2026-07-19T07:38:36.147275Z`)
- `v12/docs/perf-baselines/2026-07-20-regex-rebalance-historical-compiled-03.json` — `custom` (`2026-07-19T07:43:49.765626Z`)
- `v12/docs/perf-baselines/2026-07-20-regex-rebalance-historical-compiled-04.json` — `custom` (`2026-07-19T07:45:47.173781Z`)
...
- `v12/docs/perf-baselines/2026-07-20-regex-rebalance-compiled.json` — `custom` (`2026-07-20T06:03:45.069237Z`)
- `v12/docs/perf-baselines/2026-07-20-regex-rebalance-bytecode.json` — `custom` (`2026-07-20T06:04:06.811332Z`)
