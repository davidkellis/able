...
- Source measurements through: `2026-07-18T17:15:41.296961Z`
...
- Compiled: `5/35` selected rankable rows meet the 95%-of-Go target.
...
| `fib` | `compiled` | `verified` | 3.4240 | 3.3636 / 1.02x | n/a | n/a | `meets` | — |
| `binarytrees` | `compiled` | `verified` | 10.8240 | 12.4042 / 0.87x | n/a | n/a | `meets` | — |
| `matrixmultiply` | `compiled` | `verified` | 1.2600 | 1.1461 / 1.10x | n/a | n/a | `miss` | — |
...
| `base64` | `compiled` | `verified` | 2.7780 | 3.0974 / 0.90x | n/a | n/a | `meets` | — |
...
| `pidigits` | `compiled` | `verified` | 1.5600 | 1.4199 / 1.10x | n/a | n/a | `miss` | — |
...
- `v12/docs/perf-baselines/2026-07-18-post-string-compiled-selection-generality-compiled-01-selected.json` — `custom` (`2026-07-18T16:22:30.777211Z`)
...
- `v12/docs/perf-baselines/2026-07-18-post-string-compiled-selection-generality-compiled-03-selected.json` — `custom` (`2026-07-18T16:29:31.883331Z`)
- `v12/docs/perf-baselines/2026-07-18-post-string-compiled-selection-generality-compiled-04-selected.json` — `custom` (`2026-07-18T16:32:43.368533Z`)
