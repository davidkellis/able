...
Generated from `2026-07-23T04:55:27.757991Z` scorecard evidence. This ledger joins all 95 reviewed rows; it excludes unselected status-only rows.

## Outcome

- Selected rows: 51 compiled + 44 bytecode = 95.
- Product target: 8 meet, 87 miss.
- Established cross-cohort guards: 5 (3 compiled + 2 bytecode); 3 snapshot meets are not established.
- Aggregate time above the per-row 95%-of-reference budget: 162.313 seconds.
- Unclosed groups: 0.
...
| await_channel_mux | bytecode | meets | not-established | variance-sensitive-miss | 0.200 | 0.932 | 0.000 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
...
| channel_rollup | bytecode | miss | not-applicable | - | 0.538 | 11.423 | 0.488 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
| concurrent_document_pipeline | bytecode | miss | not-applicable | - | 0.290 | 12.664 | 0.266 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
| concurrent_event_routing | bytecode | miss | not-applicable | - | 3.256 | 96.905 | 3.221 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
| concurrent_stencil_reduction | bytecode | miss | not-applicable | - | 1.862 | 19.335 | 1.761 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
| concurrent_text_index | bytecode | miss | not-applicable | - | 0.768 | 7.893 | 0.666 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
...
| dependency_wave_validation | bytecode | miss | not-applicable | - | 0.562 | 15.921 | 0.525 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
...
| future_await_race | bytecode | miss | not-applicable | - | 0.152 | 4.578 | 0.117 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
| future_pipeline | bytecode | miss | not-applicable | - | 0.458 | 7.316 | 0.392 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
...
| mutex_await_journal | bytecode | miss | not-applicable | - | 0.196 | 6.490 | 0.164 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
| mutex_ledger | bytecode | miss | not-applicable | - | 0.376 | 10.899 | 0.340 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
| mutex_work_queue | bytecode | miss | not-applicable | - | 0.340 | 11.724 | 0.309 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
...
| validated_job_pipeline | bytecode | miss | not-applicable | - | 0.380 | 14.449 | 0.352 | current-exact-concurrent-stencil-reduction-refresh | closed-no-shared-leaf | `bytecode-concurrency` |
...
| await_channel_mux | compiled | miss | not-applicable | - | 0.360 | 65.455 | 0.354 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
...
| channel_rollup | compiled | miss | not-applicable | - | 0.598 | 94.921 | 0.591 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_document_pipeline | compiled | miss | not-applicable | - | 0.284 | 55.686 | 0.279 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_event_routing | compiled | miss | not-applicable | - | 2.914 | 520.357 | 2.908 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_stencil_reduction | compiled | miss | not-applicable | - | 0.214 | 41.961 | 0.209 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_text_index | compiled | miss | not-applicable | - | 0.996 | 155.625 | 0.989 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
...
| dependency_wave_validation | compiled | miss | not-applicable | - | 1.444 | 335.814 | 1.439 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
...
| future_await_race | compiled | miss | not-applicable | - | 0.106 | 21.633 | 0.101 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
| future_pipeline | compiled | miss | not-applicable | - | 0.396 | 69.474 | 0.390 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
...
| mutex_await_journal | compiled | miss | not-applicable | - | 0.812 | 180.444 | 0.807 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
| mutex_ledger | compiled | miss | not-applicable | - | 0.820 | 160.784 | 0.815 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
| mutex_work_queue | compiled | miss | not-applicable | - | 2.330 | 448.077 | 2.325 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
...
| validated_job_pipeline | compiled | miss | not-applicable | - | 1.046 | 275.263 | 1.042 | current-exact-concurrent-stencil-reduction-refresh | closed-rejected-candidate | `compiled-concurrency` |
...
- Disposition: `closed-rejected-candidate`; exact unlike-application breadth: 13; profile freshness: `current-exact-concurrent-stencil-reduction-refresh`; artifact identity: `frozen-current-generated-binaries-plus-validated-job-and-stencil-main-profiles`.
...
- Disposition: `closed-no-shared-leaf`; exact unlike-application breadth: 13; profile freshness: `current-exact-concurrent-stencil-reduction-refresh`; artifact identity: `frozen-current-verifier-backed-timing-plus-validated-job-and-stencil-profiles`.
...
- Rationale: Concurrent Stencil Reduction is 19.335x Python and 15.016x Ruby in its promoted cohort. Three current runtime profiles put the recurring bytecodeRawIntegerValueInfo leaf at 3.10% flat while Array read, binary, call, and type-match parents split into existing semantic children. No new concrete child is material and shared by three unlike families.
- Evidence: [2026-07-22-concurrent-stencil-reduction-application-gate.md](../../docs/perf-baselines/2026-07-22-concurrent-stencil-reduction-application-gate.md), [2026-07-21-truthiness-cast-regex-concurrency-closure-refresh.md](../../docs/perf-baselines/2026-07-21-truthiness-cast-regex-concurrency-closure-refresh.md), [2026-07-21-truthiness-cast-regex-concurrency-closure-reach.json](../../docs/perf-baselines/2026-07-21-truthiness-cast-regex-concurrency-closure-reach.json), [2026-07-21-bytecode-concurrency-fourteen-application-refresh.md](../../docs/perf-baselines/2026-07-21-bytecode-concurrency-fourteen-application-refresh.md), [2026-07-20-mutex-work-queue-profile-gate.md](../../docs/perf-baselines/2026-07-20-mutex-work-queue-profile-gate.md), [2026-07-20-bytecode-concurrency-current-profile-gate.md](../../docs/perf-baselines/2026-07-20-bytecode-concurrency-current-profile-gate.md), [2026-07-21-concurrent-document-pipeline-application-gate.md](../../docs/perf-baselines/2026-07-21-concurrent-document-pipeline-application-gate.md), [2026-07-21-concurrent-document-pipeline-promotion-bytecode.md](../../docs/perf-baselines/2026-07-21-concurrent-document-pipeline-promotion-bytecode.md), [2026-07-21-validated-job-file-entry-application-gate.md](../../docs/perf-baselines/2026-07-21-validated-job-file-entry-application-gate.md), [2026-07-21-validated-job-file-entry-comparison-d.json](../../docs/perf-baselines/2026-07-21-validated-job-file-entry-comparison-d.json), [2026-07-21-validated-job-file-entry-bytecode-profile.txt](../../docs/perf-baselines/2026-07-21-validated-job-file-entry-bytecode-profile.txt).
