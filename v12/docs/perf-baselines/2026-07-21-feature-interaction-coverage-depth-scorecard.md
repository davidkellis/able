...
- Source measurements through: `2026-07-21T16:50:18.320836Z`
...
- Compiled: `5/46` selected rankable rows meet the 95%-of-Go target.
- Bytecode: `3/39` selected rankable rows meet both 95%-of-Python and 95%-of-Ruby targets.
- Canonical Able source fingerprints: `92` row fingerprints in JSON; `92` came from the measured source report and the remainder are current-source legacy fingerprints.
- Verifier/declared-input contracts: `92` row fingerprints in JSON; `92` were captured before the timed launch and the remainder are current-contract legacy reconstructions.
...
- Strict candidate selection: `85` reviewed benchmark/mode rows, SHA-256 `d421d84b3b4760b049f02d6b32c3f947de337e02cb74e7292fa504c92418ee72`; timeout rows remain in full status.
- Matched reference source fingerprints: `133` comparison fingerprints in JSON; `133` came from measured reference reports and the remainder are current-source legacy fingerprints.
...
| `validated_job_pipeline` | `compiled` | `verified` | 3.3620 | 0.0055 / 611.27x | n/a | n/a | `miss` | — |
...
- `v12/docs/perf-baselines/2026-07-21-dynamic-i64-lazy-slot-compiled-frontier-comparison.json` — `coverage` (`2026-07-21T13:34:14.191208Z`)
