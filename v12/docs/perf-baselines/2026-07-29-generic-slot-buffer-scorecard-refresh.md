...
- Source measurements through: `2026-07-29T20:53:57.544970Z`
...
- Compiled: `7/65` selected rankable rows meet the 95%-of-Go target.
...
| `transaction_ledger_audit` | `compiled` | `verified` | 0.0500 | 0.0073 / 6.85x | n/a | n/a | `miss` | — |
| `transaction_ledger_audit` | `bytecode` | `verified` | 4.5900 | n/a | 0.0344 / 133.43x | 0.0914 / 50.22x | `miss` | — |
| `generic_slot_buffer` | `compiled` | `verified` | 0.0420 | 0.0051 / 8.24x | n/a | n/a | `miss` | — |
| `generic_slot_buffer` | `bytecode` | `verified` | 2.2580 | n/a | 0.1847 / 12.23x | 0.1037 / 21.77x | `miss` | — |
...
- `v12/docs/perf-baselines/2026-07-29-transaction-ledger-audit-scorecard-source.json` — `custom` (`2026-07-29T19:33:10.278417Z`)
- `v12/docs/perf-baselines/2026-07-29-generic-slot-buffer-scorecard-source.json` — `custom` (`2026-07-29T20:53:57.544970Z`)
