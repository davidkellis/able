...
- Source measurements through: `2026-07-27T20:00:44.352662Z`
...
- Compiled: `5/63` selected rankable rows meet the 95%-of-Go target.
- Bytecode: `3/56` selected rankable rows meet both 95%-of-Python and 95%-of-Ruby targets.
...
- Strict candidate selection: `119` reviewed benchmark/mode rows, SHA-256 `e6a6ccacc9620f9e1b89e2510cab52a85114ddbf2f41e33abae7c6d8a70241f8`; timeout rows remain in full status.
- Matched reference source fingerprints: `183` comparison fingerprints in JSON; `183` came from measured reference reports and the remainder are current-source legacy fingerprints.
...
| `sudoku_masks` | `compiled` | `verified` | 1.5740 | 0.7027 / 2.24x | n/a | n/a | `miss` | — |
...
| `tapelang_alphabet` | `compiled` | `verified` | 3.7060 | 2.9649 / 1.25x | n/a | n/a | `miss` | — |
...
| `concurrent_tree_folds` | `compiled` | `verified` | 0.3840 | 0.0037 / 103.78x | n/a | n/a | `miss` | — |
| `concurrent_tree_folds` | `bytecode` | `verified` | 0.3800 | n/a | 0.0562 / 6.76x | 0.0555 / 6.85x | `miss` | — |
| `concurrent_scene_tiles` | `compiled` | `verified` | 0.4360 | 0.0045 / 96.89x | n/a | n/a | `miss` | — |
| `concurrent_scene_tiles` | `bytecode` | `verified` | 0.6720 | n/a | 0.0765 / 8.78x | 0.0775 / 8.67x | `miss` | — |
| `concurrent_audio_voices` | `compiled` | `verified` | 0.9260 | 0.0049 / 188.98x | n/a | n/a | `miss` | — |
| `concurrent_audio_voices` | `bytecode` | `verified` | 1.2900 | n/a | 0.1335 / 9.66x | 0.1240 / 10.40x | `miss` | — |
| `concurrent_packet_codecs` | `compiled` | `verified` | 0.5060 | 0.0038 / 133.16x | n/a | n/a | `miss` | — |
| `concurrent_packet_codecs` | `bytecode` | `verified` | 0.8820 | n/a | 0.0831 / 10.61x | 0.0785 / 11.24x | `miss` | — |
| `fasta_generation` | `compiled` | `verified` | 0.0420 | 0.0166 / 2.53x | n/a | n/a | `miss` | — |
| `fasta_generation` | `bytecode` | `verified` | 1.9580 | n/a | 0.2031 / 9.64x | 0.3046 / 6.43x | `miss` | — |
| `backup_dedup` | `compiled` | `verified` | 0.0600 | 0.0092 / 6.52x | n/a | n/a | `miss` | — |
| `backup_dedup` | `bytecode` | `verified` | 1.9160 | n/a | 0.2794 / 6.86x | 0.1168 / 16.40x | `miss` | — |
| `discrete_event_simulation` | `compiled` | `verified` | 0.0580 | 0.0138 / 4.20x | n/a | n/a | `miss` | — |
| `discrete_event_simulation` | `bytecode` | `verified` | 4.7360 | n/a | 0.1698 / 27.89x | 0.2095 / 22.61x | `miss` | — |

## Source scorecards

- `v12/docs/perf-baselines/2026-07-27-fasta-source-identity-compiled-base-without-fasta.json` — `coverage` (`2026-07-26T13:03:39.879714Z`)
- `v12/docs/perf-baselines/2026-07-26-semantic-equivalence-normalized-full-bytecode-status.json` — `custom` (`2026-07-26T13:10:05.161069Z`)
- `v12/docs/perf-baselines/2026-07-27-fasta-source-identity-bytecode-base-without-fasta.json` — `custom` (`2026-07-22T17:11:45.971914Z`)
...
- `v12/docs/perf-baselines/2026-07-23-concurrent-tree-folds-cohort-a.json` — `custom` (`2026-07-23T20:08:27.700058Z`)
- `v12/docs/perf-baselines/2026-07-23-concurrent-scene-tiles-cohort-a.json` — `custom` (`2026-07-23T21:15:31.719535Z`)
- `v12/docs/perf-baselines/2026-07-23-concurrent-audio-voices-cohort-a.json` — `concurrent-audio-voices` (`2026-07-23T22:32:10.017930Z`)
- `v12/docs/perf-baselines/2026-07-23-concurrent-packet-codecs-cohort-a.json` — `concurrent-packet-codecs` (`2026-07-24T04:53:13.562683Z`)
- `v12/docs/perf-baselines/2026-07-27-fasta-source-identity-refresh-b.json` — `custom` (`2026-07-27T17:06:52.131607Z`)
- `v12/docs/perf-baselines/2026-07-27-backup-dedup-compiled.json` — `custom` (`2026-07-27T18:06:49.003590Z`)
- `v12/docs/perf-baselines/2026-07-27-backup-dedup-bytecode.json` — `custom` (`2026-07-27T18:07:10.076448Z`)
- `v12/docs/perf-baselines/2026-07-27-discrete-event-simulation-comparison.json` — `custom` (`2026-07-27T20:00:44.352662Z`)
