...
Generated from `2026-07-29T16:00:48.159470Z` scorecard evidence. This ledger joins all 126 reviewed rows; it excludes unselected status-only rows.

## Outcome

- Selected rows: 63 compiled + 63 bytecode = 126.
- Product target: 11 meet, 115 miss.
- Established cross-cohort guards: 11 (7 compiled + 4 bytecode); 0 snapshot meets are not established.
- Aggregate time above the per-row 95%-of-reference budget: 226.255 seconds.
- Unclosed groups: 0.
...
| array_slice_window | compiled | miss | not-applicable | - | 0.030 | 3.061 | 0.020 | current-exact-discrete-event-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
| await_channel_mux | compiled | miss | not-applicable | - | 0.128 | 23.273 | 0.122 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| backup_dedup | compiled | miss | not-applicable | - | 0.054 | 5.745 | 0.044 | current-exact-backup-dedup-main-profile | closed-no-shared-leaf | `compiled-text-map` |
| base64 | compiled | meets | established | established-meet | 1.998 | 0.874 | 0.000 | current-contract-two-cohort-stability | target-guard | `compiled-target-guards` |
| binary_event_log | compiled | miss | not-applicable | - | 0.148 | 8.862 | 0.130 | current-exact-discrete-event-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
| binarytrees | compiled | meets | established | established-meet | 10.270 | 0.931 | 0.000 | current-contract-two-cohort-stability | target-guard | `compiled-target-guards` |
| channel_rollup | compiled | miss | not-applicable | - | 0.048 | 8.421 | 0.042 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_audio_voices | compiled | miss | not-applicable | - | 0.040 | 8.511 | 0.035 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_document_pipeline | compiled | miss | not-applicable | - | 0.032 | 6.957 | 0.027 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_event_routing | compiled | miss | not-applicable | - | 0.042 | 8.750 | 0.037 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_graph_visitors | compiled | miss | not-applicable | - | 0.042 | 9.333 | 0.037 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_packet_codecs | compiled | miss | not-applicable | - | 0.032 | 6.809 | 0.027 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_policy_callbacks | compiled | miss | not-applicable | - | 0.034 | 7.234 | 0.029 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_scene_tiles | compiled | miss | not-applicable | - | 0.036 | 8.372 | 0.031 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_signal_dispatch | compiled | miss | not-applicable | - | 0.044 | 8.000 | 0.038 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_state_machines | compiled | miss | not-applicable | - | 0.034 | 8.293 | 0.030 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_stateful_pipeline | compiled | miss | not-applicable | - | 0.060 | 11.538 | 0.055 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_stencil_reduction | compiled | miss | not-applicable | - | 0.040 | 7.273 | 0.034 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_text_index | compiled | miss | not-applicable | - | 0.052 | 7.222 | 0.044 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_transform_chain | compiled | miss | not-applicable | - | 0.044 | 7.719 | 0.038 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| concurrent_tree_folds | compiled | miss | not-applicable | - | 0.030 | 7.500 | 0.026 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| config_validation_extraction | compiled | miss | not-applicable | - | 0.044 | 5.116 | 0.035 | current-exact-post-truthiness-cast-refresh | closed-rejected-candidate | `compiled-regex` |
| dependency_plan | compiled | miss | not-applicable | - | 0.026 | 3.421 | 0.018 | current-exact-discrete-event-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
| dependency_wave_validation | compiled | miss | not-applicable | - | 0.036 | 7.347 | 0.031 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| discrete_event_simulation | compiled | miss | not-applicable | - | 0.042 | 2.222 | 0.022 | current-exact-discrete-event-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
| distance_field | compiled | miss | not-applicable | - | 0.030 | 2.632 | 0.018 | current-exact-post-truthiness-cast-numeric-next | closed-rejected-candidate | `compiled-float-numeric` |
| document_audit | compiled | miss | not-applicable | - | 0.036 | 3.750 | 0.026 | current-exact-discrete-event-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
| fasta_generation | compiled | miss | not-applicable | - | 0.040 | 3.077 | 0.026 | current-exact-post-truthiness-cast-refresh | closed-no-shared-leaf | `compiled-byte-output` |
| fib | compiled | miss | not-applicable | - | 3.118 | 1.075 | 0.066 | current-exact-post-truthiness-cast-shared-semantics | closed-no-shared-leaf | `compiled-current-control` |
| fixed_width_128 | compiled | miss | not-applicable | - | 0.118 | 15.526 | 0.110 | current-exact | closed-rejected-candidate | `compiled-wide-numeric` |
| future_await_race | compiled | miss | not-applicable | - | 0.034 | 6.939 | 0.029 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| future_pipeline | compiled | miss | not-applicable | - | 0.030 | 4.918 | 0.024 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| i_before_e | compiled | meets | established | established-meet | 0.062 | 1.049 | 0.000 | current-exact-backup-dedup-main-profile | closed-no-shared-leaf | `compiled-text-map` |
| inventory_reconciliation | compiled | miss | not-applicable | - | 0.114 | 8.507 | 0.100 | current-exact-backup-dedup-main-profile | closed-no-shared-leaf | `compiled-text-map` |
| json | compiled | meets | established | established-meet | 0.620 | 0.473 | 0.000 | current-contract-two-cohort-stability | target-guard | `compiled-target-guards` |
| k_nucleotide | compiled | miss | not-applicable | - | 1.346 | 26.706 | 1.293 | current-exact-backup-dedup-main-profile | closed-no-shared-leaf | `compiled-text-map` |
| lexical_rollup | compiled | miss | not-applicable | - | 0.040 | 3.922 | 0.029 | current-exact-discrete-event-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
| log_routing_redaction | compiled | miss | not-applicable | - | 0.052 | 5.200 | 0.041 | current-exact-post-truthiness-cast-refresh | closed-rejected-candidate | `compiled-regex` |
| mandelbrot | compiled | miss | not-applicable | - | 0.070 | 1.518 | 0.021 | current-exact-post-truthiness-cast-numeric-next | closed-rejected-candidate | `compiled-float-numeric` |
| manifest_normalization | compiled | miss | not-applicable | - | 0.042 | 7.000 | 0.036 | current-exact-backup-dedup-main-profile | closed-no-shared-leaf | `compiled-text-map` |
| matrixmultiply | compiled | miss | not-applicable | - | 0.968 | 1.071 | 0.016 | current-exact-post-truthiness-cast-shared-semantics | closed-no-shared-leaf | `compiled-current-control` |
| monte_carlo_pi | compiled | meets | established | established-meet | 0.136 | 0.725 | 0.000 | current-contract-two-cohort-stability | target-guard | `compiled-target-guards` |
| mutex_await_journal | compiled | miss | not-applicable | - | 0.034 | 6.538 | 0.029 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| mutex_ledger | compiled | miss | not-applicable | - | 0.030 | 5.556 | 0.024 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| mutex_work_queue | compiled | miss | not-applicable | - | 0.040 | 7.273 | 0.034 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| nbody | compiled | miss | not-applicable | - | 0.074 | 2.379 | 0.041 | current-exact-post-truthiness-cast-numeric-next | closed-rejected-candidate | `compiled-float-numeric` |
| option_result_config | compiled | miss | not-applicable | - | 0.042 | 6.562 | 0.035 | current-exact-discrete-event-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
| pidigits | compiled | meets | established | established-meet | 1.070 | 0.965 | 0.000 | current-contract-two-cohort-stability | target-guard | `compiled-target-guards` |
| policy_record_dispatch | compiled | miss | not-applicable | - | 0.082 | 14.386 | 0.076 | current-exact-post-truthiness-cast-refresh | closed-rejected-candidate | `compiled-regex` |
| quicksort | compiled | meets | established | established-meet | 1.626 | 0.702 | 0.000 | current-contract-two-cohort-stability | target-guard | `compiled-target-guards` |
| rational_series | compiled | miss | not-applicable | - | 0.052 | 3.291 | 0.035 | current-exact | closed-rejected-candidate | `compiled-wide-numeric` |
| regex_set_audit | compiled | miss | not-applicable | - | 0.054 | 4.615 | 0.042 | current-exact-post-truthiness-cast-refresh | closed-rejected-candidate | `compiled-regex` |
| regex_stream_audit | compiled | miss | not-applicable | - | 0.042 | 3.853 | 0.031 | current-exact-post-truthiness-cast-refresh | closed-rejected-candidate | `compiled-regex` |
| regex_suffix_audit | compiled | miss | not-applicable | - | 0.052 | 4.727 | 0.040 | current-exact-post-truthiness-cast-refresh | closed-rejected-candidate | `compiled-regex` |
| reverse_complement | compiled | miss | not-applicable | - | 0.044 | 2.993 | 0.029 | current-exact-post-truthiness-cast-refresh | closed-no-shared-leaf | `compiled-byte-output` |
| rms_norm | compiled | miss | not-applicable | - | 0.030 | 2.778 | 0.019 | current-exact-post-truthiness-cast-numeric-next | closed-rejected-candidate | `compiled-float-numeric` |
| sensor_calibration | compiled | miss | not-applicable | - | 0.042 | 6.885 | 0.036 | current-exact-backup-dedup-main-profile | closed-no-shared-leaf | `compiled-text-map` |
| sudoku_masks | compiled | miss | not-applicable | - | 1.494 | 2.516 | 0.869 | current-exact-post-truthiness-cast-shared-semantics | closed-insufficient-breadth | `compiled-sudoku-quotient` |
| tapelang_alphabet | compiled | miss | not-applicable | - | 3.276 | 1.198 | 0.397 | current-exact-post-truthiness-cast-shared-semantics | closed-no-shared-leaf | `compiled-current-control` |
| unicode_scalar_pipeline | compiled | miss | not-applicable | - | 0.138 | 10.000 | 0.123 | current-exact-backup-dedup-main-profile | closed-no-shared-leaf | `compiled-text-map` |
| validated_job_pipeline | compiled | miss | not-applicable | - | 0.074 | 15.102 | 0.069 | current-exact-post-spawn-context-activation | closed-rejected-candidate | `compiled-concurrency` |
| wide_integer_records | compiled | miss | not-applicable | - | 0.064 | 1.270 | 0.011 | current-exact | closed-rejected-candidate | `compiled-wide-numeric` |
| word_frequency | compiled | miss | not-applicable | - | 0.038 | 2.734 | 0.023 | current-exact-backup-dedup-main-profile | closed-no-shared-leaf | `compiled-text-map` |
...
- Classification: `established-meet`; established guard: `established`; pooled limiting ratio: 0.984x go; cohort ratios: 1.049, 0.917.
- Samples: 10 Able and 10 limiting-reference; Able source: `4cabfaeebf777072eb41a2411a7b9467386be7fcb55303ede708d8da50f057d9`; evidence stdlib tree: `6a412c872ee66752de7c4417a5eda99806a7631da3b880c55574c6a640b82d9b`.
- Rationale: Both independent Go 1.26.5 five-process cohorts meet the target with verifier-backed matched references.
- Evidence: [2026-07-29-compiled-go1265-refresh.json](../../docs/perf-baselines/2026-07-29-compiled-go1265-refresh.json), [2026-07-29-compiled-go1265-stability-i-before-e.json](../../docs/perf-baselines/2026-07-29-compiled-go1265-stability-i-before-e.json).
...
- Disposition: `closed-rejected-candidate`; exact unlike-application breadth: 3; profile freshness: `current-exact-post-spawn-context-activation`; artifact identity: `selective-post-spawn-scorecard-plus-25-profile-cpu-and-three-profile-exact-allocation-intersection`.
- Owner: Fresh post-spawn CPU and exact allocation profiles across Await Channel Mux, Validated Job Pipeline, and Concurrent Stateful Pipeline find ordinary bridge.ToInt materialization in all three. bridge.currentGID is material only in the first two, while nominal struct construction is material only in the latter two.
- Rationale: bridge.ToInt averages about 4,098, 4,107, and 65,554 objects per run, but it is ordinary semantic-boundary boxing and a global integer cache already slowed the allocation-light TapeLang guard by 4.17%. currentGID accounts for 73.60% and 92.31% cumulative CPU in the first two applications but only 2.53% and 15.3 objects per run in Stateful Pipeline; broader execution-context ABI changes are closed. Nominal struct work lacks three-application breadth and non-primitive special cases are forbidden. No open general owner remains.
- Evidence: [2026-07-29-post-spawn-context-scorecard-and-owner-closure.md](../../docs/perf-baselines/2026-07-29-post-spawn-context-scorecard-and-owner-closure.md), [2026-07-29-post-spawn-context-scorecard-and-owner-closure.json](../../docs/perf-baselines/2026-07-29-post-spawn-context-scorecard-and-owner-closure.json), [2026-07-29-post-spawn-context-scorecard-refresh.json](../../docs/perf-baselines/2026-07-29-post-spawn-context-scorecard-refresh.json), [2026-07-29-compiled-spawn-gated-callable-context-retained.md](../../docs/perf-baselines/2026-07-29-compiled-spawn-gated-callable-context-retained.md), [2026-07-28-compiled-await-post-materialization-owner-closure.md](../../docs/perf-baselines/2026-07-28-compiled-await-post-materialization-owner-closure.md), [await_channel_mux-cpu-cum-top.txt](../../docs/perf-baselines/2026-07-29-post-spawn-context-residual-profiles/await_channel_mux-cpu-cum-top.txt), [await_channel_mux-alloc-objects-cum-top.txt](../../docs/perf-baselines/2026-07-29-post-spawn-context-residual-profiles/await_channel_mux-alloc-objects-cum-top.txt), [validated_job_pipeline-cpu-cum-top.txt](../../docs/perf-baselines/2026-07-29-post-spawn-context-residual-profiles/validated_job_pipeline-cpu-cum-top.txt), [validated_job_pipeline-alloc-objects-cum-top.txt](../../docs/perf-baselines/2026-07-29-post-spawn-context-residual-profiles/validated_job_pipeline-alloc-objects-cum-top.txt), [concurrent_stateful_pipeline-cpu-cum-top.txt](../../docs/perf-baselines/2026-07-29-post-spawn-context-residual-profiles/concurrent_stateful_pipeline-cpu-cum-top.txt), [concurrent_stateful_pipeline-alloc-objects-cum-top.txt](../../docs/perf-baselines/2026-07-29-post-spawn-context-residual-profiles/concurrent_stateful_pipeline-alloc-objects-cum-top.txt).
