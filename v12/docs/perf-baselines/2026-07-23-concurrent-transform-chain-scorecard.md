...
- Source measurements through: `2026-07-23T14:25:00.143928Z`
...
- Compiled: `5/53` selected rankable rows meet the 95%-of-Go target.
- Bytecode: `3/46` selected rankable rows meet both 95%-of-Python and 95%-of-Ruby targets.
- Canonical Able source fingerprints: `106` row fingerprints in JSON; `106` came from the measured source report and the remainder are current-source legacy fingerprints.
- Verifier/declared-input contracts: `106` row fingerprints in JSON; `106` were captured before the timed launch and the remainder are current-contract legacy reconstructions.
...
- Strict candidate selection: `99` reviewed benchmark/mode rows, SHA-256 `9f671bd09ce2cf43246ae6bc0cd17ee17f74783ab87071243792fc41bac2a1d3`; timeout rows remain in full status.
- Matched reference source fingerprints: `153` comparison fingerprints in JSON; `153` came from measured reference reports and the remainder are current-source legacy fingerprints.
