...
- Source measurements through: `2026-07-29T23:59:12.829005Z`
...
- Compiled: `5/65` selected rankable rows meet the 95%-of-Go target.
- Bytecode: `4/65` selected rankable rows meet both 95%-of-Python and 95%-of-Ruby targets.
- Canonical Able source fingerprints: `130` row fingerprints in JSON; `130` came from the measured source report and the remainder are current-source legacy fingerprints.
- Verifier/declared-input contracts: `130` row fingerprints in JSON; `130` were captured before the timed launch and the remainder are current-contract legacy reconstructions.
...
- Strict candidate selection: `130` reviewed benchmark/mode rows, SHA-256 `d450605f6b271fbddbda7bf31e9f61c1d87cbf1a407f9047304d79bd64ff1684`; timeout rows remain in full status.
- Matched reference source fingerprints: `195` comparison fingerprints in JSON; `195` came from measured reference reports and the remainder are current-source legacy fingerprints.
...
| `pidigits` | `compiled` | `verified` | 2.2240 | 1.2218 / 1.82x | n/a | n/a | `miss` | — |
...
| `base64` | `bytecode` | `verified` | 3.9740 | n/a | 4.4302 / 0.90x | 2.5588 / 1.55x | `miss` | — |
| `json` | `bytecode` | `verified` | 1.2080 | n/a | 2.6856 / 0.45x | 1.6625 / 0.73x | `meets` | — |
...
| `binary_event_log` | `compiled` | `verified` | 0.1640 | 0.0078 / 21.03x | n/a | n/a | `miss` | — |
...
| `manifest_normalization` | `compiled` | `verified` | 0.0400 | 0.0050 / 8.00x | n/a | n/a | `miss` | — |
...
- `v12/docs/perf-baselines/2026-07-29-nullable-scalar-retained-generality-compiled-04-selected.json` — `custom` (`2026-07-29T22:59:40.536421Z`)
...
- `v12/docs/perf-baselines/2026-07-29-nullable-scalar-retained-generality-bytecode-03-selected.json` — `custom` (`2026-07-29T23:10:31.909409Z`)
...
- `v12/docs/perf-baselines/2026-07-29-nullable-scalar-retained-coverage-extra-compiled-01-selected.json` — `custom` (`2026-07-29T23:26:48.659333Z`)
...
- `v12/docs/perf-baselines/2026-07-29-nullable-scalar-retained-coverage-extra-compiled-06-selected.json` — `custom` (`2026-07-29T23:49:09.900155Z`)
