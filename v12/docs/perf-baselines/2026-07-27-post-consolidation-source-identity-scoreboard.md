...
- Source measurements through: `2026-07-27T17:06:52.131607Z`
...
- Compiled: `5/61` selected rankable rows meet the 95%-of-Go target.
- Bytecode: `3/54` selected rankable rows meet both 95%-of-Python and 95%-of-Ruby targets.
- Canonical Able source fingerprints: `122` row fingerprints in JSON; `122` came from the measured source report and the remainder are current-source legacy fingerprints.
- Verifier/declared-input contracts: `122` row fingerprints in JSON; `122` were captured before the timed launch and the remainder are current-contract legacy reconstructions.
...
- Strict candidate selection: `115` reviewed benchmark/mode rows, SHA-256 `1dc70106786a7e668982f070428fed3a81f77ba2abb4adf72d97848265f9dead`; timeout rows remain in full status.
- Matched reference source fingerprints: `177` comparison fingerprints in JSON; `177` came from measured reference reports and the remainder are current-source legacy fingerprints.
