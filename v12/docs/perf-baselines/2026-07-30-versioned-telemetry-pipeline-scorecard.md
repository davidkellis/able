...
- Source measurements through: `2026-07-30T13:40:26.758225Z`
...
| `versioned_telemetry_pipeline` | `compiled` | `verified` | 51.4180 | 0.2201 / 233.61x | n/a | n/a | `miss` | — |
...
- `v12/docs/perf-baselines/2026-07-30-versioned-telemetry-pipeline-compiled.json` — `custom` (`2026-07-30T13:39:56.942227Z`)
