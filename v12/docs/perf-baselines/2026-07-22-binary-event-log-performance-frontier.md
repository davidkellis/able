...
| array_slice_window | compiled | miss | not-applicable | - | 0.088 | 17.600 | 0.083 | current-exact-binary-event-log-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
...
| binary_event_log | compiled | miss | not-applicable | - | 0.688 | 71.667 | 0.678 | current-exact-binary-event-log-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
...
| dependency_plan | compiled | miss | not-applicable | - | 0.094 | 22.381 | 0.090 | current-exact-binary-event-log-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
...
| document_audit | compiled | miss | not-applicable | - | 0.088 | 22.564 | 0.084 | current-exact-binary-event-log-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
...
| lexical_rollup | compiled | miss | not-applicable | - | 0.116 | 21.481 | 0.110 | current-exact-binary-event-log-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
...
| option_result_config | compiled | miss | not-applicable | - | 0.248 | 72.941 | 0.244 | current-exact-binary-event-log-main-profile | closed-no-shared-leaf | `compiled-iterator-control` |
...
- Disposition: `closed-no-shared-leaf`; exact unlike-application breadth: 2; profile freshness: `current-exact-binary-event-log-main-profile`; artifact identity: `frozen-current-timing-reach-and-binary-event-main-profile-cohorts`.
- Owner: Binary Event Log adds a large general nominal conversion/allocation path and repeats static generic-union dispatch with Option/Result Config; the other Array, graph, iterator, and text descendants remain separate.
- Rationale: Three verified current main profiles put EventRecord nominal conversion under allocation/GC and static generic-union dispatch at 29.80% cumulative. The exact union-dispatch child is now material in two unlike applications, still below the three-application admission bar, and nominal-type-specific lowering is prohibited.
- Evidence: [2026-07-22-binary-event-log-application-gate.md](../../docs/perf-baselines/2026-07-22-binary-event-log-application-gate.md), [2026-07-21-truthiness-cast-near-path-closure-refresh.md](../../docs/perf-baselines/2026-07-21-truthiness-cast-near-path-closure-refresh.md), [2026-07-21-truthiness-cast-near-path-closure-reach.json](../../docs/perf-baselines/2026-07-21-truthiness-cast-near-path-closure-reach.json), [2026-07-21-compiled-iterator-control-dynamic-i64-lazy-slot-gate.md](../../docs/perf-baselines/2026-07-21-compiled-iterator-control-dynamic-i64-lazy-slot-gate.md), [2026-07-20-current-iterator-control-profile-refresh.md](../../docs/perf-baselines/2026-07-20-current-iterator-control-profile-refresh.md), [2026-07-18-cross-mode-array-capacity-growth-gate.md](../../docs/perf-baselines/2026-07-18-cross-mode-array-capacity-growth-gate.md).
