...
- Source measurements through: `2026-07-23T20:08:27.700058Z`
...
- Compiled: `5/58` selected rankable rows meet the 95%-of-Go target.
- Bytecode: `3/51` selected rankable rows meet both 95%-of-Python and 95%-of-Ruby targets.
- Canonical Able source fingerprints: `116` row fingerprints in JSON; `116` came from the measured source report and the remainder are current-source legacy fingerprints.
- Verifier/declared-input contracts: `116` row fingerprints in JSON; `116` were captured before the timed launch and the remainder are current-contract legacy reconstructions.
...
- Strict candidate selection: `109` reviewed benchmark/mode rows, SHA-256 `faa54b0b27a55f7a9dc0ea4bbc10e856fc1d534279bc8b453d369f405e9c3b76`; timeout rows remain in full status.
- Matched reference source fingerprints: `168` comparison fingerprints in JSON; `168` came from measured reference reports and the remainder are current-source legacy fingerprints.
