...
- Compiled: `3/34` rankable rows meet the 95%-of-Go target.
- Bytecode: `4/28` rankable rows meet both 95%-of-Python and 95%-of-Ruby targets.
...
- Strict candidate selection: `62` reviewed benchmark/mode rows, SHA-256 `b048dd1dc7e8ac92557f6aaf2fb4f134a826a5b68ef6a24581b8e27e2877c6e3`; timeout rows remain in full status.
