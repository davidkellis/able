...
- Source measurements through: `2026-07-20T14:58:16.131000Z`
...
| `reverse_complement` | `bytecode` | `verified` | 4.4300 | n/a | 0.0238 / 186.13x | 0.0685 / 64.67x | `miss` | — |
| `k_nucleotide` | `bytecode` | `incomplete` | 47.1200 | n/a | 1.3274 / 35.50x | 1.3516 / 34.86x | `unranked` | Able run incomplete |
| `fasta_generation` | `bytecode` | `verified` | 1.8080 | n/a | 0.2040 / 8.86x | 0.2849 / 6.35x | `miss` | — |
...
- `v12/docs/perf-baselines/2026-07-20-hash-index-cohort-b-generality-bytecode-05-selected.json` — `custom` (`2026-07-20T14:33:46.015716Z`)
