...
- Source measurements through: `2026-07-18T18:22:33.347716Z`
...
| `i_before_e` | `bytecode` | `verified` | 0.5840 | n/a | 0.1475 / 3.96x | 0.2052 / 2.85x | `miss` | — |
| `base64` | `bytecode` | `verified` | 3.1360 | n/a | 5.2732 / 0.59x | 3.3672 / 0.93x | `meets` | — |
| `json` | `bytecode` | `verified` | 0.8540 | n/a | 2.9249 / 0.29x | 1.7617 / 0.48x | `meets` | — |
| `monte_carlo_pi` | `bytecode` | `verified` | 2.6480 | n/a | 2.0108 / 1.32x | 1.7294 / 1.53x | `miss` | — |
| `pidigits` | `bytecode` | `verified` | 2.4220 | n/a | 4.3496 / 0.56x | 11.0683 / 0.22x | `meets` | — |
| `mandelbrot` | `bytecode` | `verified` | 6.6240 | n/a | 1.2740 / 5.20x | 1.9700 / 3.36x | `miss` | — |
| `reverse_complement` | `bytecode` | `verified` | 7.0700 | n/a | 0.0269 / 262.83x | 0.0808 / 87.50x | `miss` | — |
| `k_nucleotide` | `bytecode` | `verified` | 42.9860 | n/a | 1.3879 / 30.97x | 1.4065 / 30.56x | `miss` | — |
| `distance_field` | `bytecode` | `verified` | 6.1580 | n/a | 0.6158 / 10.00x | 0.3452 / 17.84x | `miss` | — |
| `rms_norm` | `bytecode` | `verified` | 4.7640 | n/a | 0.8594 / 5.54x | 0.5674 / 8.40x | `miss` | — |
| `channel_rollup` | `bytecode` | `verified` | 0.5660 | n/a | 0.0431 / 13.13x | 0.0581 / 9.74x | `miss` | — |
| `future_pipeline` | `bytecode` | `verified` | 0.5240 | n/a | 0.0641 / 8.17x | 0.0837 / 6.26x | `miss` | — |
| `future_await_race` | `bytecode` | `verified` | 0.1880 | n/a | 0.0436 / 4.31x | 0.0661 / 2.84x | `miss` | — |
| `await_channel_mux` | `bytecode` | `verified` | 0.2520 | n/a | 0.1247 / 2.02x | 0.1048 / 2.40x | `miss` | — |
| `mutex_ledger` | `bytecode` | `verified` | 0.3880 | n/a | 0.0416 / 9.33x | 0.0528 / 7.35x | `miss` | — |
| `mutex_await_journal` | `bytecode` | `verified` | 0.2240 | n/a | 0.0261 / 8.58x | 0.0626 / 3.58x | `miss` | — |
| `fixed_width_128` | `bytecode` | `verified` | 8.2660 | n/a | 0.3823 / 21.62x | 0.7323 / 11.29x | `miss` | — |
| `rational_series` | `bytecode` | `verified` | 4.2500 | n/a | 0.1162 / 36.57x | 0.1669 / 25.46x | `miss` | — |
| `word_frequency` | `bytecode` | `verified` | 1.5840 | n/a | 0.0228 / 69.47x | 0.0636 / 24.91x | `miss` | — |
| `document_audit` | `bytecode` | `verified` | 0.3420 | n/a | 0.0153 / 22.35x | 0.0529 / 6.47x | `miss` | — |
| `lexical_rollup` | `bytecode` | `verified` | 0.5700 | n/a | 0.0282 / 20.21x | 0.0608 / 9.38x | `miss` | — |
| `regex_set_audit` | `bytecode` | `verified` | 4.3340 | n/a | 0.0224 / 193.48x | 0.0497 / 87.20x | `miss` | — |
| `regex_stream_audit` | `bytecode` | `verified` | 3.8060 | n/a | 0.0229 / 166.20x | 0.0563 / 67.60x | `miss` | — |
| `array_slice_window` | `bytecode` | `verified` | 0.8040 | n/a | 0.0322 / 24.97x | 0.0710 / 11.32x | `miss` | — |
| `dependency_plan` | `bytecode` | `verified` | 0.5200 | n/a | 0.0193 / 26.94x | 0.0558 / 9.32x | `miss` | — |
| `option_result_config` | `bytecode` | `verified` | 0.8900 | n/a | 0.0190 / 46.84x | 0.0552 / 16.12x | `miss` | — |
| `unicode_scalar_pipeline` | `bytecode` | `verified` | 3.5300 | n/a | 0.2903 / 12.16x | 0.3431 / 10.29x | `miss` | — |
...
- `v12/docs/perf-baselines/2026-07-18-post-quickening-bytecode-generality.json` — `custom` (`2026-07-18T18:18:55.060672Z`)
- `v12/docs/perf-baselines/2026-07-18-post-quickening-bytecode-async.json` — `custom` (`2026-07-18T18:19:31.505151Z`)
- `v12/docs/perf-baselines/2026-07-18-post-quickening-bytecode-coverage.json` — `custom` (`2026-07-18T18:22:33.347716Z`)
