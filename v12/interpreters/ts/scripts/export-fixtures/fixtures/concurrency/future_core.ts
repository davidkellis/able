...
export const futureCoreFixtures: Fixture[] = [
  {
        name: "concurrency/future_cancel_value",
        module: AST.module([
          AST.assign(
            "handle",
            AST.spawnExpression(AST.blockExpression([AST.integerLiteral(0)])),
          ),
          AST.assign(
            "_cancelResult",
            AST.functionCall(
        ...
        manifest: {
          description: "Future cancellation before start returns an error value",
          expect: {
            result: { kind: "error" },
          },
        },
  ...
  {
        name: "concurrency/future_cancelled_outside_error",
        module: AST.module([
          AST.functionCall(AST.identifier("future_cancelled"), []),
        ]),
        manifest: {
          description: "future_cancelled raises when called outside of a spawned task",
          expect: {
            errors: ["future_cancelled must be called inside an asynchronous task"],
          },
        },
      },

  {
        name: "concurrency/future_yield_flush",
        module: AST.module([
        ...
        manifest: {
          description: "future_yield cooperates with future_flush to resume the task",
          expect: {
  ...
  {
        name: "concurrency/future_flush_fairness",
        module: AST.module([
          AST.assign("trace", AST.stringLiteral("")),
        ...
        manifest: {
          description: "future_flush drains the queue in creation order to keep scheduling fair",
          expect: {
...
export default futureCoreFixtures;
