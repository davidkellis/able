...
const futureMemoizationFixtures: Fixture[] = [
  {
        name: "concurrency/future_value_memoization",
        module: AST.module([
        ...
        manifest: {
          description: "Future handle value() memoises successful results",
          expect: {
            result: {
              kind: "array",
              length: 3,
  ...
  {
        name: "concurrency/future_value_cancel_memoization",
        module: AST.module([
        ...
        manifest: {
          description: "Cancelled future value() calls return identical memoized errors",
          expect: {
            result: {
              kind: "array",
              length: 3,
              elements: [
                { kind: "String", value: "Future cancelled" },
                { kind: "String", value: "Future cancelled" },
                { kind: "String", value: "0" },
              ],
            },
...
export default futureMemoizationFixtures;
