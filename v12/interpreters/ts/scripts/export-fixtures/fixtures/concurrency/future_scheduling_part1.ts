...
export const futureSchedulingPart1: Fixture[] = [
{
        name: "concurrency/future_cancelled_helper",
        module: AST.module([
        ...
        manifest: {
          description: "Future uses future_cancelled() after yielding to observe cancellation flag",
          expect: {
  ...
  {
        name: "concurrency/fairness_future_round_robin",
        module: AST.module([
        ...
        manifest: {
          description: "Yielding futures make progress without one jumping ahead of the other",
          expect: {
            result: {
              kind: "array",
              elements: [
  ...
  {
        name: "concurrency/fairness_future_interleaving",
        module: AST.module([
        ...
        manifest: {
          description: "Two futures advance between yields without overtaking one another",
          expect: {
            result: {
              kind: "array",
              elements: [
...

  {
      ...
      manifest: {
        description: "Future handle errors expose FutureError causes to handlers",
        expect: {
...
export default futureSchedulingPart1;
