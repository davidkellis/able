...
func (g *generator) renderRuntimeHelpers(buf *bytes.Buffer) {
	...
	fmt.Fprintf(buf, "\t\t\treturn __able_index_error(index, length)\n")
	fmt.Fprintf(buf, "\t\t}\n")
	...
	fmt.Fprintf(buf, "\t\t\t\t__able_panic_on_error(err)\n")
	fmt.Fprintf(buf, "\t\t\t\treturn __able_index_error(-1, length)\n")
	fmt.Fprintf(buf, "\t\t\t}\n")
	fmt.Fprintf(buf, "\t\t\treturn val\n")
	fmt.Fprintf(buf, "\t\t}\n")
	fmt.Fprintf(buf, "\t}\n")
	...
	fmt.Fprintf(buf, "\t\t\treturn __able_index_error(index, length)\n")
	fmt.Fprintf(buf, "\t\t}\n")
	fmt.Fprintf(buf, "\t\t__able_panic_on_error(runtime.ArrayStoreWrite(arr.Handle, index, value))\n")
	...
	fmt.Fprintf(buf, "\t\t\t\treturn __able_index_error(index, length)\n")
	fmt.Fprintf(buf, "\t\t\t}\n")
	fmt.Fprintf(buf, "\t\t\t__able_panic_on_error(runtime.ArrayStoreWrite(handle, index, value))\n")
	fmt.Fprintf(buf, "\t\t\treturn value\n")
	fmt.Fprintf(buf, "\t\t}\n")
	fmt.Fprintf(buf, "\t\tif inst.Definition != nil && inst.Definition.Node != nil && inst.Definition.Node.ID != nil && inst.Definition.Node.ID.Name == \"HashMap\" {\n")
	fmt.Fprintf(buf, "\t\t\thandleVal, ok := inst.Fields[\"handle\"]\n")
