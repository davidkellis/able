...
func TestCompilerBuildExecSearchPathsRejectsDistinctStdlibRoots(t *testing.T) {
	root := t.TempDir()
	...
	_, err := buildExecSearchPaths(entryPath, fixtureDir, interpreter.FixtureManifest{})
	if err == nil {
