...
func (i *Interpreter) initRatioBuiltins() {
	...
	f32Bits := runtime.NativeFunctionValue{
		...
		Impl: func(_ *runtime.NativeCallContext, args []runtime.Value) (runtime.Value, error) {
			...
			case runtime.FloatValue:
				...
				return runtime.NewSmallInt(int64(bits), runtime.IntegerU32), nil
			case *runtime.FloatValue:
	...
	f64Bits := runtime.NativeFunctionValue{
		...
		Impl: func(_ *runtime.NativeCallContext, args []runtime.Value) (runtime.Value, error) {
			...
			case runtime.FloatValue:
				...
				return runtime.NewBigIntValue(new(big.Int).SetUint64(bits), runtime.IntegerU64), nil
			case *runtime.FloatValue:
	...
	u64Mul := runtime.NativeFunctionValue{
		...
		Impl: func(_ *runtime.NativeCallContext, args []runtime.Value) (runtime.Value, error) {
			...
			product := lhs * rhs
			return runtime.NewBigIntValue(new(big.Int).SetUint64(product), runtime.IntegerU64), nil
		},
	}
...
func expectU64(value runtime.Value) (uint64, error) {
	...
	case runtime.IntegerValue:
		if v.TypeSuffix != runtime.IntegerU64 {
	...
	case *runtime.IntegerValue:
		if v == nil || v.TypeSuffix != runtime.IntegerU64 {
			return 0, fmt.Errorf("__able_u64_mul expects u64 inputs")
		}
		bi := v.BigInt()
		if !bi.IsUint64() {
