...
func TestBytecodeVM_LoweringSkipsF64MatrixRowLoopPlan(t *testing.T) {
	...
	if len(program.f64MatrixRowLoops) != 0 {
		t.Fatalf("matrix-only f64 matrix-row plans should stay empty, got %#v", program.f64MatrixRowLoops)
	}
}
