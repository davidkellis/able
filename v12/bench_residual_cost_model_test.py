...
class ResidualCostModelTests(unittest.TestCase):
    ...
    def test_current_model_reconciles_and_selects_no_leaf(self) -> None:
        ...
        self.assertAlmostEqual(summary["selected_excess_seconds"], 66.374632, places=6)
        self.assertAlmostEqual(
            summary["frontier_total_excess_seconds"], 230.851579, places=6
        )
        self.assertAlmostEqual(
            summary["selected_excess_share_percent"], 28.75208, places=6
        )
